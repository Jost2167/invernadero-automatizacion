...
@WebMvcTest(
        controllers = GreenhouseAlertController.class,
        excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = JwtAuthenticationFilter.class))
@AutoConfigureMockMvc(addFilters = false)
class GreenhouseAlertControllerTest {

    private static final String BASE_PATH = "/api/greenhouse-alert";
    ...
    @MockBean
    private GreenhouseAlertService greenhouseAlertService;

    @Test
    void findAll_returns200() throws Exception {
        GreenhouseAlert entity = entityWithId(1L);
        when(greenhouseAlertService.findAll()).thenReturn(List.of(entity));
    ...
    void findById_whenExists_returns200() throws Exception {
        GreenhouseAlert entity = entityWithId(1L);
        when(greenhouseAlertService.findById(1L)).thenReturn(Optional.of(entity));
    ...
    void findById_whenNotFound_returns404() throws Exception {
        when(greenhouseAlertService.findById(999L)).thenReturn(Optional.empty());
    ...
    void create_returns201() throws Exception {
        GreenhouseAlert entity = entityWithId(1L);
        when(greenhouseAlertService.save(any(GreenhouseAlert.class))).thenReturn(entity);
    ...
    private GreenhouseAlert entityWithId(Long id) {
