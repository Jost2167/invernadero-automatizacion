...
@WebMvcTest(
        controllers = GreenhouseController.class,
        excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = JwtAuthenticationFilter.class))
@AutoConfigureMockMvc(addFilters = false)
class GreenhouseControllerTest {

    private static final String BASE_PATH = "/api/greenhouse";
    ...
    void findAll_returns200() throws Exception {
        Greenhouse entity = entityWithId(1L);
        when(greenhouseService.findAll()).thenReturn(List.of(entity));
    ...
    void findById_whenExists_returns200() throws Exception {
        Greenhouse entity = entityWithId(1L);
        when(greenhouseService.findById(1L)).thenReturn(Optional.of(entity));
    ...
    void findById_whenNotFound_returns404() throws Exception {
        when(greenhouseService.findById(999L)).thenReturn(Optional.empty());
    ...
    void create_returns201() throws Exception {
        Greenhouse entity = entityWithId(1L);
        when(greenhouseService.save(any(Greenhouse.class))).thenReturn(entity);
    ...
    private Greenhouse entityWithId(Long id) {
