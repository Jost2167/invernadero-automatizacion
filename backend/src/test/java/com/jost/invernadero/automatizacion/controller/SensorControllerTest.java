...
class SensorControllerTest {
    ...
    private static final String BASE_PATH = "/api/sensor";
    ...
    void findAll_returns200() throws Exception {
        Sensor entity = entityWithId(1L);
        when(sensorService.findAll()).thenReturn(List.of(entity));
    ...
    void findById_whenExists_returns200() throws Exception {
        Sensor entity = entityWithId(1L);
        when(sensorService.findById(1L)).thenReturn(Optional.of(entity));
    ...
    void findById_whenNotFound_returns404() throws Exception {
        when(sensorService.findById(999L)).thenReturn(Optional.empty());
    ...
    void create_returns201() throws Exception {
        Sensor entity = entityWithId(1L);
        when(sensorService.save(any(Sensor.class))).thenReturn(entity);
    ...
    private Sensor entityWithId(Long id) {
