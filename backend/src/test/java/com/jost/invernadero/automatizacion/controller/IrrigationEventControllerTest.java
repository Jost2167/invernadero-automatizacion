...
@WebMvcTest(
        controllers = IrrigationEventController.class,
        excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = JwtAuthenticationFilter.class))
@AutoConfigureMockMvc(addFilters = false)
class IrrigationEventControllerTest {

    private static final String BASE_PATH = "/api/irrigation-event";
    ...
    void findAll_returns200() throws Exception {
        IrrigationEvent entity = entityWithId(1L);
        when(irrigationEventService.findAll()).thenReturn(List.of(entity));
    ...
    void findById_whenExists_returns200() throws Exception {
        IrrigationEvent entity = entityWithId(1L);
        when(irrigationEventService.findById(1L)).thenReturn(Optional.of(entity));
    ...
    void findById_whenNotFound_returns404() throws Exception {
        when(irrigationEventService.findById(999L)).thenReturn(Optional.empty());
    ...
    void create_returns201() throws Exception {
        IrrigationEvent entity = entityWithId(1L);
        when(irrigationEventService.save(any(IrrigationEvent.class))).thenReturn(entity);
    ...
    private IrrigationEvent entityWithId(Long id) {
