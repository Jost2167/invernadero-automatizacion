...
class LocationControllerTest {
    ...
    void findAll_returns200() throws Exception {
        Location entity = entityWithId(1L);
        when(locationService.findAll()).thenReturn(List.of(entity));
    ...
    void findById_whenExists_returns200() throws Exception {
        Location entity = entityWithId(1L);
        when(locationService.findById(1L)).thenReturn(Optional.of(entity));
    ...
    private Location entityWithId(Long id) {
