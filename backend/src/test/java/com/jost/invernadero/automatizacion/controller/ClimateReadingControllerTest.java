...
@WebMvcTest(
        controllers = ClimateReadingController.class,
        excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = JwtAuthenticationFilter.class))
@AutoConfigureMockMvc(addFilters = false)
class ClimateReadingControllerTest {

    private static final String BASE_PATH = "/api/climate-reading";
    ...
    @MockBean
    private ClimateReadingService climateReadingService;

    @Test
    void findAll_returns200() throws Exception {
        ClimateReading entity = entityWithId(1L);
        when(climateReadingService.findAll()).thenReturn(List.of(entity));
    ...
    void findById_whenExists_returns200() throws Exception {
        ClimateReading entity = entityWithId(1L);
        when(climateReadingService.findById(1L)).thenReturn(Optional.of(entity));
    ...
    void findById_whenNotFound_returns404() throws Exception {
        when(climateReadingService.findById(999L)).thenReturn(Optional.empty());
    ...
    void create_returns201() throws Exception {
        ClimateReading entity = entityWithId(1L);
        when(climateReadingService.save(any(ClimateReading.class))).thenReturn(entity);
    ...
    private ClimateReading entityWithId(Long id) {
